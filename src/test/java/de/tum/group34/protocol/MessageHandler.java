...
public abstract class MessageHandler<C> {
  ...
  public void parseMessage(ByteBuffer buf)
    ...
    try {
      type = Protocol.MessageType.asMessageType(Message.getUnsignedShort(buf));
   ...
   */
  public abstract void parseMessage(ByteBuffer buf, Protocol.MessageType type, C closure)
      throws MessageParserException, ProtocolException;
}
